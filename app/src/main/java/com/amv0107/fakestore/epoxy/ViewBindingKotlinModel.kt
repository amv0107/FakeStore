package com.amv0107.fakestore.epoxy

import android.view.View
import androidx.annotation.LayoutRes
import androidx.viewbinding.ViewBinding
import com.airbnb.epoxy.EpoxyModel
import com.amv0107.fakestore.R
import java.lang.reflect.Method
import java.lang.reflect.ParameterizedType
import java.util.concurrent.ConcurrentHashMap

/**
 * A patter for using epoxy models with Kotlin with no annotations or code generation.
 *
 * See [com.airbnb.epoxy.kotlinsample.models.ItemViewBindingDataClass] for a usage example.
 *
 * If You use Proguard or R8, be sure to keep thi bind method available with the following configuration:
 *
 * -keepclassmembers class * exended androidx.viewbinding.ViewBinding {
